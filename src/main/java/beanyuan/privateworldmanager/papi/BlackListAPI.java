...
public class BlackListAPI extends PlaceholderExpansion {
    private final PrivateWorldManager plugin;

    public BlackListAPI(PrivateWorldManager plugin) {
        this.plugin = plugin;
    }
    ...
    public String onPlaceholderRequest(Player player, String params) {
        if (player != null) {
            ...
            if (worldIndex >= 0) {
                ...
                return WorldManager.formatPlayerList(WorldManager.getBlackList(world));
            }
        }
