...
public class WorldSpawnLocationAPI extends PlaceholderExpansion {

    private final PrivateWorldManager plugin;

    public WorldSpawnLocationAPI(PrivateWorldManager plugin) {
        this.plugin = plugin;
    }
    ...
    public String onPlaceholderRequest(Player player, String params) {
        if (player != null) {
            int worldIndex = 0;
            if (params.contains("_world_") && params.contains("_spawn_location")) {
            ...
            if (worldIndex >= 0) {
                ...
                return PrivateWorldManager.worldData.getSpawnLocation(world);
            }
        }
